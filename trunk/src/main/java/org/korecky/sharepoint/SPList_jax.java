...
//        GetViewCollectionResult result = WsContext.getVViewsStub(new URL(webAbsluteUrl)).getViewCollection(name);
...
//        List<SPListItem> itemsCollection = null;
//        GetListItemsResult result = WsContext.getListsStub(new URL(webAbsluteUrl)).getListItems(name, viewName, query, viewFields, String.valueOf(rowLimit), queryOptions, webId);
//        for (Object content : result.getContent()) {
//            if (content instanceof Element) {
//                Element rootElement = (Element)content;
//                NodeList dataNodeList = rootElement.getElementsByTagNameNS("urn:schemas-microsoft-com:rowset", "data");
