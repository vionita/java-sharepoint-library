 ...
 *
 */
public class SPListItems extends SpObject {
    ...
    public SPListItems(String xmlString) throws XMLStreamException {
        ...
        if (xmlElement != null) {
            try {
                ...
                Logger.getLogger(SPListItems.class.getName()).log(Level.SEVERE,
                        null, ex);
            }
        }
    }
    ...
    public SPListItems(OMElement xmlElement) throws XMLStreamException {
        try {
            ...
            Logger.getLogger(SPListItems.class.getName())
    ...
    /**
     * @param listItemCollection the listItemCollection to set
     */
