...
import org.korecky.sharepoint.General.AggregationEnum;
import org.korecky.sharepoint.General.NegativeFormatEnum;
import org.korecky.sharepoint.General.ShowFieldEnum;
import org.korecky.sharepoint.General.SpBaseTypeEnum;
import org.korecky.sharepoint.General.StorageTZEnum;
...
public class SPField extends SpObject {
    ...
    public SPField(final String xmlString) throws XMLStreamException {
        ...
        if (xmlElement != null) {
            try {
                ...
                Logger.getLogger(SPField.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
    ...
    /**
     * @param allowHyperlink the allowHyperlink to set
     */
    ...
    /**
     * @param allowMultiVote the allowMultiVote to set
     */
    ...
    /**
     * @param appendOnly the appendOnly to set
     */
    ...
    /**
     * @param authoringInfo the authoringInfo to set
     */
    ...
    /**
     * @param canToggleHidden the canToggleHidden to set
     */
    ...
    /**
     * @param commas the commas to set
     */
    ...
    /**
     * @param displaceOnUpgrade the displaceOnUpgrade to set
     */
    ...
    /**
     * @param displayNameSrcField the displayNameSrcField to set
     */
    ...
    /**
     * @param enableLookup the enableLookup to set
     */
    ...
    /**
     * @param enforceUniqueValues the enforceUniqueValues to set
     */
    ...
    /**
     * @param exceptionImage the exceptionImage to set
     */
    ...
    /**
     * @param fillInChoice the fillInChoice to set
     */
    ...
    /**
     * @param forcedDisplay the forcedDisplay to set
     */
    ...
    /**
     * @param forcePromoteDemote the forcePromoteDemote to set
     */
    ...
    /**
     * @param htmlEncode the htmlEncode to set
     */
    ...
    /**
     * @param iMEMode the iMEMode to set
     */
    ...
    /**
     * @param isolateStyles the isolateStyles to set
     */
    ...
    /**
     * @param joinColName the joinColName to set
     */
    ...
    /**
     * @param joinRowOrdinal the joinRowOrdinal to set
     */
    ...
    /**
     * @param linkToItem the linkToItem to set
     */
    ...
    /**
     * @param linkToItemAllowed the linkToItemAllowed to set
     */
    ...
    /**
     * @param listItemMenu the listItemMenu to set
     */
    ...
    /**
     * @param noEditFormBreak the noEditFormBreak to set
     */
    ...
    /**
     * @param prependId the prependId to set
     */
    ...
    /**
     * @param primaryPITarget the primaryPITarget to set
     */
    ...
    /**
     * @param readOnlyEnforced the readOnlyEnforced to set
     */
    ...
    /**
     * @param relationshipDeleteBehavior the relationshipDeleteBehavior to set
     */
    ...
    /**
     * @param renderXMLUsingPattern the renderXMLUsingPattern to set
     */
    ...
    /**
     * @param restrictedMode the restrictedMode to set
     */
    ...
    /**
     * @param richTextMode the richTextMode to set
     */
    ...
    /**
     * @param rowOrdinal the rowOrdinal to set
     */
    ...
    /**
     * @param separateLine the separateLine to set
     */
    ...
    /**
     * @param showAddressBookButton the showAddressBookButton to set
     */
    ...
    /**
     * @param listItemMenuAllowed the listItemMenuAllowed to set
     */
    ...
    /**
     *
     * @param internalShowField the internal field name
     */
    ...
    /**
     *
     * @param fieldName fieldName to control
     * @return true if it's an internal field name (when field type is Lookup),
     * otherwise false.
     */
    ...
    /**
     * @param showInVersionHistory the showInVersionHistory to set
     */
    ...
    /**
     * @param showInViewForms the showInViewForms to set
     */
    ...
    /**
     * @param staticName the staticName to set
     */
    ...
    /**
     * @param storageTZ the storageTZ to set
     */
    ...
    /**
     * @param stripWS the stripWS to set
     */
    ...
    /**
     * @param suppressNameDisplay the suppressNameDisplay to set
     */
    ...
    /**
     * @param unlimitedLengthInDocumentLibrary the
     * unlimitedLengthInDocumentLibrary to set
     */
    ...
    /**
     * @param urlEncodeAsUrl the urlEncodeAsUrl to set
     */
    ...
    /**
     * @param userSelectionMode the userSelectionMode to set
     */
    ...
    /**
     * @param userSelectionScope the userSelectionScope to set
     */
    ...
    /**
     * @param wikiLinking the wikiLinking to set
     */
