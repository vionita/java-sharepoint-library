 ...
 */
@RunWith(Suite.class)
@Suite.SuiteClasses({org.korecky.sharepoint.SPSiteTest.class, org.korecky.sharepoint.SPWebTest.class})
//, org.korecky.sharepoint.SPListTest.class, org.korecky.sharepoint.SPAlertTest.class, org.korecky.sharepoint.SPFileBaseTest.class, org.korecky.sharepoint.SPListTemplateTest.class, org.korecky.sharepoint.SPListItemTest.class, , org.korecky.sharepoint.SPViewTest.class, org.korecky.sharepoint.SPAttachmentTest.class, org.korecky.sharepoint.SPFileTest.class, org.korecky.sharepoint.SPFolderTest.class, org.korecky.sharepoint.SPTest.class
public class TestSuite {
    ...
    public static void setUpClass() throws Exception {
        credentials = new NtlmAuthenticator("DOMAIN", "user", "password");
        httpProxy = new HttpProxy("127.0.0.1", 8888);
        site = new SPSite(new URL("https://server/"), credentials, httpProxy, true);
    }
